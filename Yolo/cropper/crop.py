...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', type=str, help='Path to the folder containing the images')
    parser.add_argument('--labels', type=str, help='Path to the folder containing the label files')
