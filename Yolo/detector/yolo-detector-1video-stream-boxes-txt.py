...
def detect_objects(model, rtsp_url, save_txt, output_path, conf = 0.5):
    ...
    while True:
        ...
        for result in results.pred:
            ...
            for i, det in enumerate(result):
                ...
                text_size, _ = cv2.getTextSize(label, cv.FONT_HERSHEY_SIMPLEX, 0.4, 1)
...
def main():
    ...
    parser.add_argument('--save_txt', '-txt', type=bool, default=0, help='1: salva frames e relative labels associate, 0/non inserito: visualizza soltanto il video con le bounding')
    parser.add_argument('--output', '--out', type=str, help='output path for labels and frames save')
    ...
    detect_objects(model, rtsp_url, save_txt, output_path)
